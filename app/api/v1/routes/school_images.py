...
async def upload_school_images(
    ...
    ### S3 Storage:
    - **Bucket**: your-app-bucket (configurable via S3_BUCKET_NAME env var)
        ...
        "uploaded": [
            {
                ...
                "s3_url": "https://your-app-bucket.s3.your-region.amazonaws.com/school_images/12345678901/school_logo.png",
            ...
            },
            {
                ...
                "s3_url": "https://your-app-bucket.s3.your-region.amazonaws.com/school_images/12345678901/building.jpg",
            ...
            },
            {
                ...
                "s3_url": "https://your-app-bucket.s3.your-region.amazonaws.com/school_images/12345678901/playground.jpg",
                "content_type": "image/jpeg"
            }
        ]
    }
    ...
    - **Scope**: User must have access to the school's organizational hierarchy
        ...
        - Organization Admin: Can upload images for schools in their organization
