...
async def create_organization(
    ...
    ### Notes:
    - Only Super Admin and Organization Admin can create organizations
...
async def get_organizations(
    ...
    - Organization Admin sees their organization
...
async def get_blocks(
    ...
    - Organization Admin sees blocks in their organization
...
async def get_schools(
    ...
    - Organization Admin sees schools in their organization
